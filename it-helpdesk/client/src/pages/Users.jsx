...
const ROLE_OPTIONS = ['employee', 'agent', 'admin'];
    ...
    <div>
      ...
      {showForm && (
        <form
          ...
          className="mb-6 grid grid-cols-1 gap-4 rounded-xl border border-slate-200 bg-white p-5 shadow-soft sm:grid-cols-2 lg:grid-cols-5"
        >
